    ...
    createBlogCard(post, index) {
        ...
        article.innerHTML = `
            <div class="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <div class="p-6">
                    <h3 class="text-2xl font-bold text-gray-800 mb-3 hover:text-green-700 transition-colors duration-300">
                        ${post.title}
                    </h3>
                    <p class="text-gray-600 mb-4 line-clamp-2">
                        ${post.description}
                    </p>
                    <a href="${post.link}" class="inline-flex items-center text-green-700 font-semibold hover:text-green-800 transition-colors duration-300 group">
                        Read More 
